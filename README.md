...
Володя — интеграция, архитектура, README, PDF. Максим — исторический анализ, EDA. Диана — модель данных, атрибуция, метрики. Гоша — ноутбуки, сбор постов. Саша — ROMI-калькулятор.
