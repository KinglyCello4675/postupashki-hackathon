...
Владимир — интеграция, архитектура, README, PDF. Максим — исторический анализ, EDA. Диана — модель данных, атрибуция, метрики. Георгий — ноутбуки, сбор постов, анализ метрик. Александр — ROMI-калькулятор.
